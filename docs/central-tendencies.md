...
::: {.cell example='true' title='Mean of a Sample'}
...
::: {.cell example='true' title='Median, Sample Size Odd'}
Suppose we have the following sample data:
...
::: {.cell example='true' title='Median, Sample Size Even'}
...
::: {.cell example='true' title='Mode of a Sample'}
...
::: {.cell example='true' title='Salaries of a Company'}
