...
::: {.cell example='true' title='Quantitative Variables'}
...
::: {.cell example='true' title='These Are Not Quantitative Variables'}
...
::: {.cell example='true' title='Categorical Variables'}
...
::: {.cell example='true' title='Type of Variable'}
