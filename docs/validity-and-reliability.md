...
::: {.cell example='true' title='Creating Potions'}
...
::: {.cell example='true' title='Gamma Radiation of Cosmic Tesseract'}
...
::: {.cell}
::: {.cell-output-display}
![](validity-and-reliability_files/figure-html/unnamed-chunk-3-1.png){width=50%}
:::

::: {.cell-output-display}
![](validity-and-reliability_files/figure-html/unnamed-chunk-3-2.png){width=50%}
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![](validity-and-reliability_files/figure-html/unnamed-chunk-4-1.png){width=50%}
:::

::: {.cell-output-display}
![](validity-and-reliability_files/figure-html/unnamed-chunk-4-2.png){width=50%}
:::
:::
