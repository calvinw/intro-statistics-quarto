...
::: {.cell example='true' title='Whether or Not A Student Has Black Hair'}
...
::: {.cell example='true' title='Instructor\'s Age'}
...
::: {.cell example='true' title='Height'}
...
::: {.cell example='true' title='Height of Shortest Student'}
...
::: {.cell example='true' title='Zip Code'}
