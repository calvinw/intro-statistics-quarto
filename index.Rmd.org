...
The techniques used in this book are similar to *Mathplosion* [@mathplosion] but updated to use *Quarto* [@R-quarto].

Quarto is inspired by the RMarkdown format, see *The R Markdown and knitr Book* [@xie2015]
